...
dadad_scan "$_DUMPFILE" "term.text :Facility IDRUN18589934593"
dadad_scan "$_DUMPFILE" "term.element.text :Facility IDRUN18589934593"
dadad_scan "$_DUMPFILE" "term.text :Short Description"
dadad_scan "$_DUMPFILE" "blockinfo.end :148"
